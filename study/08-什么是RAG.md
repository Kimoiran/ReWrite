...
分块后：
  块 1：「克诺站在雨中，看着孤儿院的大门……」  → 来自第一章
  块 2：「塞拉丝翻开书，阳光透过窗户……」        → 来自第二章
  ...
...
# 注入 RAG 结果
user: "【参考内容】
  第三章第二节：雨下了一整夜，克诺听着屋檐的水声睡不着。
  第七章第一节：窗外又下起了雨，塞拉丝放下了书。
  ...
...
| 场景 | 用哪个 | 为什么 |
|------|--------|--------|
| 「克诺的年龄是多少？」 | Skill：get_characters | 知道要找"克诺"这个角色 |
| 「特因城在哪个国家？」 | Skill：get_map | 有明确的 parent_id 关系 |
| 「描写下雨的段落」 | RAG：search_chapters | 不知道在哪一章 |
| 「克诺和塞拉丝第一次见面的场景」 | RAG：search_chapters | 记不清章节和细节 |
| 「把第一章标题改成序章」 | Skill：rename_chapter | 知道是第一章 |
| 「找出所有提到"水神"的地方」 | RAG：search_chapters | 可能分散在多个章节 |
